defmodule DomoapiIntercomWeb.FallbackController do
  @moduledoc """
  ...
  def call(conn, {:error, %Ecto.Changeset{} = changeset}) do
    ...
    |> put_view(DomoapiIntercomWeb.ChangesetView)
  ...
  def call(conn, {:error, :not_found}) do
    ...
    |> put_view(DomoapiIntercomWeb.ErrorView)
    |> render(:"404")
  end
  ...
  def call(conn,  {:error, :no_connection}) do
    ...
    conn
    |> put_status(403)
    |> json(%{status: 403, error: "no_connection"})
  end
